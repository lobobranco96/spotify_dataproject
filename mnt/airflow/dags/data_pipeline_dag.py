...
with DAG(
    ...
    def spark_dtransformation(**kwargs):
        ...
        application='/spark_job/data_transformation.py',
        conn_id='spark_default',
        conf={
            "spark.executor.memory": "2g",
            "spark.executor.cores": "2",
            "spark.jars": "/opt/airflow/dags/jars/aws-java-sdk-bundle-1.12.262.jar, /opt/airflow/dags/jars/hadoop-aws-3.3.4.jar",
           # "spark.hadoop.fs.s3a.connection.ssl.enabled": "false",
        },
        application_args=["s3a://raw/playlist_20250323_190824.json"],
        verbose=True
        ).execute(kwargs)
